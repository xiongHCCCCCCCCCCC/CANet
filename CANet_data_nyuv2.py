...
train_file = '/seagate/zhouhao/CANet/data/nyuv2/train.txt'
test_file = '/seagate/zhouhao/CANet/data/nyuv2/test.txt'
...
def make_dataset_fromlst(listfilename):
    ...
    with open(listfilename) as f:
        ...
        for x in content:
            ...
            images += [imgname.replace('/home/hxx', '/seagate/zhouhao/CANet')]
            segs += [segname.replace('/home/hxx', '/seagate/zhouhao/CANet')]
            depths += [depthname.replace('/home/hxx', '/seagate/zhouhao/CANet')]
